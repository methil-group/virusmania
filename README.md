...
1. **Receive a brief (government order)**  
...
- **Nak0_x** — Developer — [GitHub](https://github.com/nak0x)
...
### 3D Modeling
- **Nak0_x** — 3D Modeling — [GitHub](https://github.com/nak0x)
- **math-pixel** — 3D Modeling — [GitHub](https://github.com/math-pixel)
